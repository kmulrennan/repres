...
par(mfrow=c(2, 1))
f <- plot(wd_interval_steps_mean$interval, wd_interval_steps_mean$steps, type = "l", 
          xlab = "Interval", ylab = "Steps", col = "red", main = "Weekdays", 
          ylim = c(0, 250))
g <- plot(we_interval_steps_mean$interval, we_interval_steps_mean$steps, type = "l", 
          xlab = "Interval", ylab = "Steps", col = "blue", main = "Weekends", 
          ylim = c(0, 250))
